import model.components.ServiceShop;
...
public class TestServiceShop {
    ...
    public void setUp() {
        ...
        volvoCar = new Volvo240(4, 100, Color.BLACK, "model.components.Volvo240");
    }
    ...
    public void testCapacityLimit() {
        for (int i = 0; i < 5; i++) {
            volvoShop.load(new Volvo240(4, 100, Color.BLACK, "model.components.Volvo240-" + i));
        }
